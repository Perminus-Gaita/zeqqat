...
export const metadata: Metadata = {
  title: "About - Zeqqat",
  description: "Test your SportPesa jackpot picks risk free. Save your predictions and see how they perform.",
};
  ...
  return (
    <div className="max-w-4xl mx-auto pt-6 pb-12">
      <div className="text-center">
        ...
        <Link href="/" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
        <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Go through each match and select Home, Draw, or Away. Build as many prediction sets as you want.</p>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Save multiple prediction sets and keep track of all your different strategies without spending a shilling.</p>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">After the games finish, see how your picks performed. Learn what works and refine your approach.</p>
        </div>
      </div>
    </div>
  );
